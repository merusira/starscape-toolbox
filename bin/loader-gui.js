...
let AvailableModuleListUrl = "https://raw.githubusercontent.com/merusira/moduleLists/master/moduleList-10002.json";
...
// Patch switching is no longer needed - removed
...
class TeraProxyGUI {
	...
	show() {
		...
		try {
			...
			this.tray.setToolTip("TeraStarscape - Left-click to show/hide, Right-click for menu");
